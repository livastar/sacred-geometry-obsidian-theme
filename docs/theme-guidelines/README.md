...
- Community catalog entry uses `name: "Sacred Geometry Systems"`, `author: "livastar"`, `repo: "livastar/sacred-geometry-obsidian-theme"`, `screenshot: "assets/screenshot-catalog.png"`, and `modes: ["dark", "light"]`.
...
- Keep `manifest.json` normalized to official theme metadata fields and aligned with the public catalog author `livastar` and repository name `livastar/sacred-geometry-obsidian-theme`.
